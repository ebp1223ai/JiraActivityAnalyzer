...
fs.rmSync(path.join(outdir, "analysis-bridge-v0322.cjs"), { force: true });
...
const bridgeOutput = path.join(outdir, "analysis-bridge-v0322.cjs");
esbuild.buildSync({
  ...common,
...
fs.writeFileSync(path.join(outdir, "analysis-bridge-manifest.json"), JSON.stringify({
  schemaVersion: "jaa-analysis-bridge-manifest-v1", version: "0.3.22-bridge-v5", relativePath: "analysis-bridge-v0322.cjs",
...
console.log(`  analysis bridge manifest  version=0.3.22-bridge-v5 sha256=${bridgeSha256}`);
