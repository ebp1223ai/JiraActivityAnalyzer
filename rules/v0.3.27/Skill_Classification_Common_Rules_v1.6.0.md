...
- File: `Skill_Classification_Common_Rules_v1.6.0.md`
- Rules Version: `1.6.0`
...
本版延續 v1.5.0 的 Evidence 權重、計分公式、Status 語意、Snapshot 與 Report Data Package 分層，並將模型 Evidence contract 進版為 Decision v5：
...
本節說明 v1.6.0 如何套用至 JiraActivityAnalyzer。Evidence 權重與計分公式維持 v1.1.0；本版補齊 Decision v5、Frozen Evidence Segment、Evidence Role、聚合驗證、診斷 HTML、Report Data Package、Snapshot reference、本機 HTML renderer 與跨 Run 共存邊界。
