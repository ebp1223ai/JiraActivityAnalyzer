...
function ResultsPage({ snapshot, update, notify }: PageProps) {
  ...
  return <div className="space-y-4">
    ...
    {run ? <Section eyebrow="v0.3.18 canonical artifact validation" title="Result Validation" description="以下數字由 JAA 本機驗證與 canonical assembly 計算，不使用模型自述值。">
...
export function AiAnalysisReconstructedPage() {
  ...
  return (
    <div className="min-w-0 pb-8" data-ui-version="0.3.18">
