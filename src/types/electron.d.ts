  ...
  interface Window {
    desktopApp?: {
      ...
      fullFetchStagingAction: (payload: { stagingId: string; action: "open_folder" | "export_completed" | "delete_failed" }) => Promise<Record<string, unknown>>;
        ...
        saveFullFetchResult: (payload: { attemptId: string; selectedTimelineRunId: string; fullFetchRunId: string; stagingId: string }) => Promise<{ canceled: boolean; operationId?: string; filePath?: string; folderPath?: string; fileSize?: number; sha256?: string; staging?: Record<string, unknown>; fileSave?: Record<string, unknown>; databaseWrite?: Record<string, unknown>; logs?: string[] }>;
