  ...
  interface Window {
    desktopApp?: {
      ...
      userAnalysis?: {
        ...
        buildActivityTimeline: (payload: { connection: JiraConnection; selectedUser: string; startDate: string; endDate: string; projectScope: string; requestWindow: { type: "1_day" | "7_days" | "14_days" | "calendar_month" | "custom_days"; customDays: number | null }; forcedRetryCount: number; mergeStrategy: "union" | "last_stable" }) => Promise<Record<string, unknown>>;
