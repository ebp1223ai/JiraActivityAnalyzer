  ...
  interface Window {
    desktopApp?: {
      ...
      userAnalysis?: {
        ...
        buildActivityTimeline: (payload: { connection: JiraConnection; selectedUser: string; startDate: string; endDate: string; projectScope: string }) => Promise<Record<string, unknown>>;
