    ...
    <div>
      ...
      <SectionCard>
        <div className="grid grid-cols-[1fr_280px] gap-5">
          <div><FieldLabel label="Selected Users" sub="比較使用者" /><div className="field flex gap-2"><Chip>Alpha-Platform</Chip><Chip>Ben Service</Chip><Chip>Chia-Ting Wu</Chip><button className="btn ml-auto"><Plus size={16} />新增使用者</button></div></div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-3">
        ...
        <SectionCard title="5. 近期重點" subtitle="Recent Highlights" className="col-span-2">
          <div className="grid grid-cols-2 gap-3 text-sm font-semibold text-ink">
