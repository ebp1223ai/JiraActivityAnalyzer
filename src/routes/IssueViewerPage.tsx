...
const activityEventColumns: SqliteTableColumn[] = [
  { id: "eventTime", label: "Time", kind: "date", width: 176, render: (row) => <span className="whitespace-nowrap">{formatDisplayTime(row.eventTime)}</span> },
  { id: "displayName", label: "Actor", kind: "text", width: 180, render: (row) => formatActivityActor(row) },
  { id: "eventType", label: "Action", kind: "multi", width: 170, render: (row) => formatActivityEventType(row.eventType) },
