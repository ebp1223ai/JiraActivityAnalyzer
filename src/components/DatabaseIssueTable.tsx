  ...
  return (
    <div className="min-w-0" aria-busy={loading} data-table-id="databaseIssueList">
      ...
      {settingsOpen && !disabled ? <div className="mb-3 rounded-md border border-line bg-slate-50 p-3">
        <div className="mb-3 flex items-center justify-between gap-3"><b className="text-sm">欄位設定 / Column Settings</b><button className="btn" type="button" onClick={() => onPreferencesChange({ visibleColumns: [...DEFAULT_DATABASE_COLUMNS], columnOrder: [...DEFAULT_DATABASE_COLUMNS], columnWidths: {}, pageSize: 50 })}><RotateCcw size={15} />Reset</button></div>
