...
const initialIssueViewer: IssueViewerSessionState = {
  ...
  payloadFilter: "",
  payloadPage: 1,
  changelogQuery: { page: 1, pageSize: 50, sort: { field: "eventTime", direction: "desc" }, filters: {}, dateRange: { shortcut: "all", startDate: "", endDate: "" }, revision: 0, descriptionChangedOnly: false, includeBeforeUnavailable: false, diffQuickFilters: { hideNoChange: true, hideZeroAdded: false, hideZeroDeleted: false } },
  ...
  activityEventsQuery: { page: 1, pageSize: 50, sort: { field: "eventTime", direction: "desc" }, filters: {}, dateRange: { shortcut: "all", startDate: "", endDate: "" }, diffQuickFilters: { hideNoChange: true, hideZeroAdded: false, hideZeroDeleted: false }, revision: 0 },
...
const initialUserViewer: UserViewerSessionState = {
  ...
  eventQuery: { page: 1, pageSize: 50, sort: { field: "eventTime", direction: "desc" }, filters: {}, dateRange: { shortcut: "all", startDate: "", endDate: "" }, diffQuickFilters: { hideNoChange: true, hideZeroAdded: false, hideZeroDeleted: false }, revision: 0 },
  relatedResult: null,
