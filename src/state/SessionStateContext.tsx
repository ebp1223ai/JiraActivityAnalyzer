...
const initialIssueViewer: IssueViewerSessionState = {
  ...
  activityEventsQuery: { page: 1, pageSize: 50, sort: { field: "eventTime", direction: "desc" }, filters: {}, dateRange: { shortcut: "all", startDate: "", endDate: "" }, revision: 0 },
...
const initialUserViewer: UserViewerSessionState = {
  ...
  eventQuery: { page: 1, pageSize: 50, sort: { field: "eventTime", direction: "desc" }, filters: {}, dateRange: { shortcut: "all", startDate: "", endDate: "" }, revision: 0 },
  relatedResult: null,
