...
const initialIssueViewer: IssueViewerSessionState = {
  ...
  payloadFilter: "",
  payloadPage: 1,
  changelogQuery: { page: 1, pageSize: 50, sort: { field: "eventTime", direction: "desc" }, filters: {}, dateRange: { shortcut: "all", startDate: "", endDate: "" }, revision: 0, descriptionChangedOnly: false, includeBeforeUnavailable: false, diffQuickFilters: { hideNoChange: true, hideZeroAdded: false, hideZeroDeleted: false, hideBeforeUnavailable: false } },
  ...
  descriptionChangedOnly: false,
  includeBeforeUnavailable: false,
  activityEventsQuery: { page: 1, pageSize: 50, sort: { field: "eventTime", direction: "desc" }, filters: {}, dateRange: { shortcut: "all", startDate: "", endDate: "" }, diffQuickFilters: { hideNoChange: true, hideZeroAdded: false, hideZeroDeleted: false, hideBeforeUnavailable: false }, revision: 0 },
...
const initialUserViewer: UserViewerSessionState = {
  ...
  project: "all",
  sort: "newest",
  relatedQuery: { page: 1, pageSize: 50, sort: { field: "lastActivity", direction: "desc" }, filters: {}, dateRange: { shortcut: "all", startDate: "", endDate: "" }, revision: 0 },
  eventQuery: { page: 1, pageSize: 50, sort: { field: "eventTime", direction: "desc" }, filters: {}, dateRange: { shortcut: "all", startDate: "", endDate: "" }, diffQuickFilters: { hideNoChange: true, hideZeroAdded: false, hideZeroDeleted: false, hideBeforeUnavailable: false }, revision: 0 },
  relatedResult: null,
