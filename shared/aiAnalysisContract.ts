...
export type AiAnalysisErrorCode =
  ...
  | "AI_REQUIRED_FILE_NOT_OBSERVED"
  | "AI_OUTPUT_SCHEMA_COUNT_CONSTRAINT_UNSUPPORTED"
  | "AI_PROVIDER_RESPONSE_EMPTY"
  | "AI_PROVIDER_RESPONSE_JSON_INVALID"
  | "AI_PROVIDER_RESPONSE_SCHEMA_INVALID"
  | "AI_RESULT_COUNT_MISMATCH"
  | "AI_RESULT_SOURCE_HASH_MISMATCH"
  | "AI_RESULT_SKILL_ID_INVALID"
  ...
  | "AI_RUNTIME_CONTRACT_REGISTRY_MISMATCH"
  | "AI_RUNTIME_MANIFEST_HANDLE_CONTRACT_MISMATCH"
  | "AI_RUNTIME_MANIFEST_FILE_COUNT_MISMATCH"
  | "AI_RUNTIME_MANIFEST_RECORD_COUNT_MISMATCH"
  | "AI_RUNTIME_MANIFEST_SEGMENT_MISMATCH"
  | "AI_RUNTIME_MANIFEST_FILE_HASH_MISMATCH"
  | "AI_RUNTIME_MANIFEST_FILE_BYTES_MISMATCH"
  | "AI_RUNTIME_MANIFEST_SERIALIZATION_MISMATCH"
  | "AI_PROVIDER_DISPATCH_BLOCKED"
  | "AI_ARTIFACT_NOT_SUBMITTED"
  | "AI_MODEL_INPUT_DELIVERY_INCOMPLETE"
  | "AI_MODEL_INPUT_SEGMENT_INVALID"
  | "AI_MODEL_INPUT_CURSOR_MISMATCH"
  | "AI_MODEL_INPUT_DUPLICATE_SEGMENT"
  | "AI_MODEL_INPUT_RETRY_EXHAUSTED"
  | "AI_MODEL_INPUT_SEGMENT_HASH_MISMATCH"
  ...
  | "AI_DECISION_QUALITY_GATE_BLOCKED"
  ...
  | "AI_DECISION_ROOT_TYPE_MISMATCH"
  | "AI_DECISION_INDEX_SET_MISMATCH"
  | "AI_DECISION_SCHEMA_MISMATCH"
  ...
  | "PRIMARY_CHANGE_QUOTE_REQUIRED"  | "AI_ARTIFACT_SUBMISSION_REJECTED"
  | "AI_ARTIFACT_CONTRACT_VERSION_MISMATCH"
  | "AI_RULE_SET_BINDING_MISMATCH"
  | "AI_REPORT_COUNT_MISMATCH"
  ...
  | "CODEX_BUNDLED_RUNTIME_START_FAILED"
...
export type AiRunStatus = "queued" | "preparing" | "running" | "validating" | "retrying" | "cancelling" | "cancelled" | "completed" | "completed_with_warnings" | "completed_with_quality_warnings" | "completed_with_artifact_error" | "completed_with_report_error" | "completed_with_persistence_error" | "partial" | "failed" | "failed_validation" | "provider_failed" | "provider_timeout" | "interrupted" | "recovered_interrupted";
...
export type AiRulesSnapshot = {
  ...
  multiSkillCoverageVersion?: string;
...
export type AiAnalysisRequestPackage = { requestPackageVersion: string; applicationVersion?: string; promptIdentity?: string; qualityContractVersion?: string; bridgeIdentity?: string; rulesSnapshotId?: string; instructionMode?: AiInstructionMode; instructionComposition?: AiInstructionComposition; modelInputTransport?: "bridge-resumable-v2" | "bridge-resumable-v3" | "bridge-resumable-v4"; promptLocale?: "zh-TW"; responseLocale?: "zh-TW"; promptTemplateVersion?: string; decisionContractVersion?: string; decisionContractSha256?: string; runId: string; createdAtLocal: string; createdAtUtc: string; localTimeZone: string; deliveryMode: ProviderDeliveryMode; inputRecordCount: number; inputStableIdSetSha256: string; pendingSourceSha256: string; documents: RequestPackageDocument[]; coreInstructionName: string; coreInstructionVersion: string; coreInstructionSha256: string; supplementalInstructionSha256: string | null; outputSchemaSha256: string; finalProviderPayloadSha256: string; finalProviderPayloadBytes: number; inlineBlockCount: number; nativeFileCount: number; workspaceFileCount?: number; inlineFileContentCount?: number; nativeInputFileCount?: number };
export type AiAnalysisConversationEvent = { schemaVersion: string; runId: string; sequence: number; eventId: string; messageId: string | null; parentMessageId: string | null; role: "software" | "assistant" | "system"; atLocal: string; atUtc: string; type: "user_message" | "prepared_message" | "assistant_delta" | "assistant_message" | "system_event" | "provider_event" | "validation_event" | "artifact_event"; visibility: "CHATGPT_VISIBLE" | "APP_ONLY"; visibleToProvider: boolean; contentType: "text" | "json" | "metadata" | "error"; content: string; contentByteLength: number; contentSha256: string; providerRequestId: string | null; threadId: string | null; turnId: string | null; metadata: Record<string, unknown>; previousHash: string | null; hash: string };
...
export type AiAnalysisRun = {
  ...
  instructionComposition?: AiInstructionComposition | null;
  userAdditionalInstruction?: string | null;
