...
export type DescriptionDiffSide = { available: boolean; complete: boolean; value?: unknown; raw?: string | null };
...
export type DescriptionDiffResult = { eventId: string; issueKey: string; fieldIdentity: string; sourceType: string; sourceId: string | null; status: DescriptionDiffStatus; hunks: DiffHunk[]; addedLines: number; deletedLines: number; changedHunks: number; beforeAvailable: boolean; afterAvailable: boolean; beforeComplete: boolean; afterComplete: boolean; beforeLength: number | null; afterLength: number | null; diffInputBeforeSha256: string | null; diffInputAfterSha256: string | null; diagnosticsCode: DescriptionDiffDiagnosticsCode | null };
