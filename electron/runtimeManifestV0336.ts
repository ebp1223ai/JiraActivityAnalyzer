...
export type ModelInputManifestV0336 = {
...
export type RuntimeManifestReceiptV0336 = {
...
export function validateModelInputManifestV3(value: unknown, runtimeContract: RuntimeContractV0336 = RUNTIME_CONTRACT_V0336) {
  ...
  return { manifest: manifest as ModelInputManifestV0336, fileCount: files.length, recordCount: Number(manifest.expectedRecordCount), segmentCount: totalSegments, totalBytes };
}

export function serializeAndValidateManifestResponseV0336(value: unknown, runtimeContract: RuntimeContractV0336 = RUNTIME_CONTRACT_V0336) {
...
export function createRuntimeManifestReceiptV0336(value: unknown, providerDispatchAllowed: boolean, runtimeContract: RuntimeContractV0336 = RUNTIME_CONTRACT_V0336): RuntimeManifestReceiptV0336 {
  const source = object(value);
  const preHash = sha256(JSON.stringify(value));
  try {
    const response = serializeAndValidateManifestResponseV0336(value, runtimeContract);
...
export function writeRuntimeManifestReceiptV0336(runDirectory: string, fileName: string, receipt: RuntimeManifestReceiptV0336) {
