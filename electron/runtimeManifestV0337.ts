...
export type ModelInputManifestV0337 = {
...
export type RuntimeManifestReceiptV0337 = {
...
export function validateModelInputManifestV3(value: unknown, runtimeContract: RuntimeContractV0337 = RUNTIME_CONTRACT_V0337) {
  ...
  return { manifest: manifest as ModelInputManifestV0337, fileCount: files.length, recordCount: Number(manifest.expectedRecordCount), segmentCount: totalSegments, totalBytes };
}

export function serializeAndValidateManifestResponseV0337(value: unknown, runtimeContract: RuntimeContractV0337 = RUNTIME_CONTRACT_V0337) {
...
export function createRuntimeManifestReceiptV0337(value: unknown, providerDispatchAllowed: boolean, runtimeContract: RuntimeContractV0337 = RUNTIME_CONTRACT_V0337): RuntimeManifestReceiptV0337 {
  const source = object(value);
  const preHash = sha256(JSON.stringify(value));
  try {
    const response = serializeAndValidateManifestResponseV0337(value, runtimeContract);
...
export function writeRuntimeManifestReceiptV0337(runDirectory: string, fileName: string, receipt: RuntimeManifestReceiptV0337) {
