...
contextBridge.exposeInMainWorld("desktopApp", {
  ...
  aiAnalysis: {
    ...
    startChatGpt: () => ipcRenderer.invoke("ai-analysis:chatgpt-start"),
    loginChatGpt: () => ipcRenderer.invoke("ai-analysis:chatgpt-login"),
    cancelChatGptLogin: () => ipcRenderer.invoke("ai-analysis:chatgpt-cancel-login"),
    logoutChatGpt: () => ipcRenderer.invoke("ai-analysis:chatgpt-logout"),
    refreshChatGpt: () => ipcRenderer.invoke("ai-analysis:chatgpt-refresh"),
    selectChatGptModel: (model: string | null) => ipcRenderer.invoke("ai-analysis:chatgpt-select-model", model),
    ...
    testConnection: (service: "chatgpt" | "ai_nexus") => ipcRenderer.invoke("ai-analysis:test-connection", service),
    diagnose: (service: "chatgpt" | "ai_nexus") => ipcRenderer.invoke("ai-analysis:diagnose", service),
    cancelDiagnostic: () => ipcRenderer.invoke("ai-analysis:cancel-diagnostic"),
    chat: (payload: unknown) => ipcRenderer.invoke("ai-analysis:chat", payload),
    cancelChat: () => ipcRenderer.invoke("ai-analysis:cancel-chat"),
    chooseRules: () => ipcRenderer.invoke("ai-analysis:choose-rules"),
    chooseRuleRole: (role: string) => ipcRenderer.invoke("ai-analysis:choose-rule-role", role),
    cancelRuleDraft: () => ipcRenderer.invoke("ai-analysis:cancel-rule-draft"),
    useBundledRules: () => ipcRenderer.invoke("ai-analysis:use-bundled-rules"),
    loadRules: () => ipcRenderer.invoke("ai-analysis:load-rules"),
    choosePending: () => ipcRenderer.invoke("ai-analysis:choose-pending"),
    verifyPending: (datasetId: string) => ipcRenderer.invoke("ai-analysis:verify-pending", datasetId),
    selectPending: (datasetId: string) => ipcRenderer.invoke("ai-analysis:select-pending", datasetId),
    ...
    activateResult: (activeResultId: string) => ipcRenderer.invoke("ai-analysis:activate-result", activeResultId),
    start: (payload: unknown) => ipcRenderer.invoke("ai-analysis:start", payload),
    reprocessPersisted: (runId: string) => ipcRenderer.invoke("ai-analysis:reprocess-persisted", runId),
