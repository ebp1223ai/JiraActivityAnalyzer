...
export const DEFAULT_ANALYSIS_INSTRUCTION=`# Standard Formal 正式分析契約 JAA-CHATGPT-ZH-TW-0.3.29
...
Prompt Identity=JAA-CHATGPT-ZH-TW-0.3.29
Prompt Template=0.3.29-zh-TW-v10
Bridge=0.3.29-bridge-v11
