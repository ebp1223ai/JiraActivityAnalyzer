...
import { RUNTIME_CONTRACT_V0334, type RuntimeContractV0334 } from "./runtimeContractRegistryV0334.js";
...
export type ModelInputManifestV0334 = {
...
export type RuntimeManifestReceiptV0334 = {
...
export function validateModelInputManifestV3(value: unknown, runtimeContract: RuntimeContractV0334 = RUNTIME_CONTRACT_V0334) {
  ...
  return { manifest: manifest as ModelInputManifestV0334, fileCount: files.length, recordCount: Number(manifest.expectedRecordCount), segmentCount: totalSegments, totalBytes };
}

export function serializeAndValidateManifestResponseV0334(value: unknown, runtimeContract: RuntimeContractV0334 = RUNTIME_CONTRACT_V0334) {
...
export function createRuntimeManifestReceiptV0334(value: unknown, providerDispatchAllowed: boolean, runtimeContract: RuntimeContractV0334 = RUNTIME_CONTRACT_V0334): RuntimeManifestReceiptV0334 {
  const source = object(value);
  const preHash = sha256(JSON.stringify(value));
  try {
    const response = serializeAndValidateManifestResponseV0334(value, runtimeContract);
...
export function writeRuntimeManifestReceiptV0334(runDirectory: string, fileName: string, receipt: RuntimeManifestReceiptV0334) {
